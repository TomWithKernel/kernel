...
#export FZF_DEFAULT_OPTS='--preview "[[ $(file --mime {}) =~ binary ]] && echo {} is a binary file || (rougify {}  || highlight -O ansi -l {} || coderay {} || cat {}) 2> /dev/null" --height 50% --reverse --border'

#bind -x '"\C-f": "$(fzf)"'
# Custom FZF command to open the selected file
fzf-open() {
  local file
